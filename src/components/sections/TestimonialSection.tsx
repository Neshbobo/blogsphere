  ...
  const reviews = [
    {
      ...
      position: "Radio Africa, Kenya",
      review:
        "'ve learned so much from the tutorials and guides on Blogsphere. It's helped me increase my online presence and attract more readers.",
    },
    {
      id: 2,
      imageUrl: "/images/mike.png",
      reviewerName: "Edwin Thomas",
      position: "CEO Starndard Newspaper, UK",
      review:
        "Blogsphere has been a game-changer for my blogging journey. The community is supportive, and the resources are top-notch.",
    },
  ];
  return (
